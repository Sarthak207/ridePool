    ...
    <div className="relative w-full h-full flex flex-col bg-blue-100 rounded-b-2xl shadow-lg overflow-hidden">
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='text-right'>
          ...
          <h4 className='text-xl font-semibold -mt-1 -mb-1'>MH20 BY 6235</h4>
          <p className='text-sm text-gray-600'> Garkheda Parisar,CSM</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center pt-14 px-6 pb-6 h-full">
        ...
        <button className="mt-8 w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-xl font-semibold text-lg shadow transition">
          Confirm
        </button>
      </div>
    </div>
